...
import gui.panels.mainpanels.TellerDashboardPanel;
import gui.panels.mainpanels.TellerProfilePanel;

public class TellerSidebarPanel extends JPanel {
    ...
    public TellerSidebarPanel(Database db, PanelEventListener panelEventListener, Teller t) {
