...
import gui.panels.mainpanels.ProfilePanel;
import gui.panels.mainpanels.TransactionsPanel;
...
public class SidebarPanel extends JPanel {
    ...
    public SidebarPanel(Database db, PanelEventListener listener, Client c) {
